import { Body, Controller, Delete, Get, Logger, Param, ParseIntPipe, Patch, Post, Query, UseFilters, UseGuards, UsePipes, ValidationPipe } from '@nestjs/common';
...
export class TasksController {
    ...
    @Patch('/:id/status')
    updateTaskStatus(@Param('id', ParseIntPipe) id: number, @Body('status', TaskStatusValidationPipe) status: TaskStatus, @GetUser() user: User): Promise<TaskEntity> {
